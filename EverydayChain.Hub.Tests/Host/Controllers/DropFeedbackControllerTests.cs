...
public sealed class DropFeedbackControllerTests {
    ...
    /// <summary>
    /// 执行 ConfirmAsync_ShouldReturnBadRequest_WhenActualChuteCodeIsEmpty 方法。
    /// </summary>
    [Fact]
    public async Task ConfirmAsync_ShouldReturnBadRequest_WhenActualChuteCodeIsEmpty() {
        // 步骤：执行 ConfirmAsync_ShouldReturnBadRequest_WhenActualChuteCodeIsEmpty 方法的核心处理流程。
    ...
    /// <summary>
    /// 执行 ConfirmAsync_ShouldReturnBadRequest_WhenDropTimeKindIsNonLocal 方法。
    /// </summary>
    [Fact]
    public async Task ConfirmAsync_ShouldReturnBadRequest_WhenDropTimeKindIsNonLocal() {
        // 步骤：执行 ConfirmAsync_ShouldReturnBadRequest_WhenDropTimeKindIsNonLocal 方法的核心处理流程。
        var controller = new DropFeedbackController(new StubDropFeedbackService());
        var request = new DropFeedbackRequest {
            Barcode = "BC001",
    ...
    /// <summary>
    /// 执行 ConfirmAsync_ShouldReturnOk_WhenRequestIsValid 方法。
    /// </summary>
    [Fact]
    public async Task ConfirmAsync_ShouldReturnOk_WhenRequestIsValid() {
        // 步骤：执行 ConfirmAsync_ShouldReturnOk_WhenRequestIsValid 方法的核心处理流程。
    ...
    /// <summary>
    /// 执行 ConfirmAsync_ShouldTrimTaskCode_WhenTaskCodeHasPadding 方法。
    /// </summary>
    [Fact]
    public async Task ConfirmAsync_ShouldTrimTaskCode_WhenTaskCodeHasPadding() {
        // 步骤：执行 ConfirmAsync_ShouldTrimTaskCode_WhenTaskCodeHasPadding 方法的核心处理流程。
        var stubService = new StubDropFeedbackService();
        var controller = new DropFeedbackController(stubService);
        var request = new DropFeedbackRequest {
            Barcode = "BC001",
    ...
    /// <summary>
    /// 执行 ConfirmAsync_ShouldUseEmptyTaskCode_WhenTaskCodeIsWhitespace 方法。
    /// </summary>
    [Fact]
    public async Task ConfirmAsync_ShouldUseEmptyTaskCode_WhenTaskCodeIsWhitespace() {
        // 步骤：执行 ConfirmAsync_ShouldUseEmptyTaskCode_WhenTaskCodeIsWhitespace 方法的核心处理流程。
        var stubService = new StubDropFeedbackService();
        var controller = new DropFeedbackController(stubService);
        var request = new DropFeedbackRequest {
            Barcode = "BC001",
